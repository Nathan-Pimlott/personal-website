                ...
                <Grid item xs={12} sm={10} md={8} lg={6} xl={4}>
                    ...
                    <div className={classes.largeMarginTop}>
                        ...
                        <Typography className={classes.marginTop}>
                            ...
                            Pokémon fan) or reading manga.
                        </Typography>
                        <Typography>
                            I've also been studying 日本語 for the last year or
                            ...
                            consuming (who would have thought? 🤷‍♂️). I'm hoping
                            to get over to 日本 sometime in the next couple of
                            years as well.
                        </Typography>
                    </div>
                </Grid>
